...
public class Charis07153_NotaPerhariEntity extends Charis07153_NotaAbstractEntity{
    ...
    public Charis07153_NotaPerhariEntity(String TanggalMasuk,String BulanMasuk,String TahunMasuk, int TanggalKeluar,int BulanKeluar,int TahunKeluar, String Kondisi, int Harga,int NoNota) {
    ...
    public Charis07153_NotaPerhariEntity(){
    }
