...
public class Charis07153_NotaPerjamEntity extends Charis07153_NotaAbstractEntity{
    ...
    public Charis07153_NotaPerjamEntity(int Harga, int NoNota, String kondisi,Date TanggalMasuk, String JamMasuk, String MenitMasuk, int JamKeluar, int MenitKeluar){
    ...
    public Charis07153_NotaPerjamEntity(){
    }
